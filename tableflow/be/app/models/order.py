...
class Order(Base):
    ...
    waiter_id = Column(Integer, ForeignKey("users.id", ondelete="RESTRICT"), nullable=False)
    status = Column(Enum("received", "preparing", "ready", "delivered", "cancelled"), nullable=False, default="received")
